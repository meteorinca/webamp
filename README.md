# 🎛️ YoYo Webamp & Milkdrop Visualizer
...
![YoYo Webamp Banner](https://raw.githubusercontent.com/captbaritone/webamp/master/packages/webamp/demo/preview.png)
...
2. Go to **Settings** ⚙️ $\rightarrow$ **Pages** (in the left sidebar).
